    ...
    <div class="col-md-12">
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-plus-square-o fa-lg"></i><?= __('Product Wise Monthly Sales Report') ?>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <?php
                                echo $this->Form->input('year', ['options'=>$years, 'class'=>'form-control year', 'empty'=>'Select', 'required'=>'required']);
