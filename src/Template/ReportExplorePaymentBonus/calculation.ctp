...
<table class="table table-bordered">
    ...
    if (sizeof($returnArray) > 0):
        ?>
        <tr><td colspan="12" class="text-center"><span class="label label-success crossSpan">Payment Bonus Detail</span></td></tr>
        <tr>
            <th>Customer Name</th>
            <th>Code</th>
            <th>Address</th>
        ...
        foreach ($returnArray as $customer_id=>$returnData):
            ...
            <tr class="customerTr">
                <td>
                    ...
                    <div class="amount" style="display: none;"><?= $returnData?></div>
                    <div class="start_date" style="display: none;"><?= $data['start_date']?></div>
                    <div class="end_date" style="display: none;"><?= $data['end_date']?></div>
