    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-picture-o fa-lg"></i><?= __('Formulation Log Details') ?>
                </div>
                <div class="tools">
                ...
                <div class="table-scrollable">
                    <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><?= $this->Number->format($formulationLog->created_date) ?></td>
                                </tr>
                                    ...
                                    <td><?= $this->Number->format($formulationLog->updated_date) ?></td>
                                </tr>
                                                                                                                    </table>
                </div>
            </div>
