        ...
        <div id="PrintArea" style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="text-align: right">
                                <h3>Invoice</h3>
                                <h5>Invoice Type: <?= Configure::read('invoice_type')[$poArray['invoice_type']]?></h5>
                                <h5>Invoice Time: <?= date('h:i:s', $poArray['created_date']+(6*60*60))?></h5>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="pull-right" style="text-align: right">
                                <h5>Order No: <?=$poArray['field_po_no']?></h5>
                                <h5>Invoice No: <?=$invoice_no?></h5>
                                <h5>Invoice Date: <?=date('d-m-Y', $poArray['invoice_date'])?></h5>
                                <h5>Delivery Date: <?=date('d-m-Y', $poArray['delivery_date'])?></h5>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <div>
                <table class="table" style="border: 0;">
                    ...
                    $sum_less_discount = 0;
                    $sum_net_value = 0;
                    foreach($poArray['po_products'] as $key=>$product):
                    ?>
                        <tr>
                            <td><?=$key+1?></td>
