...
<tr class="itemTr">
    <td><?= $itemName?></td>
    <td><input type="text" name="detail[<?= $item_unit_id?>][item_quantity]" class="form-control item_quantity" value="" /><input type="hidden" class="itemId" name="itemId[]" value="<?=$item_unit_id?>"></td>
