        ...
        <div class="portlet box blue-hoki">
            ...
            <div class="portlet-body">
                <div class="table-scrollable">
                    <table class="table table-bordered table-hover">
                        ...
                        <?php foreach ($items as $key => $row): ?>
                            <tr>
                                <td><?= $key + 1 ?></td>
                                <td><?php echo SystemHelper::getItemAlias($row['item']['id'], $warehouses[0]['id']); ?></td>
                ...
                <form class="form-horizontal" method="post"
                      action="<?php echo Router::url('/', true); ?>ReceivePiDelivery/view/<?= $id ?>"
                    ...
                    <div class="form-group input select required">
                        ...
                        <div id="" class="col-sm-3">
                            <select  name="do_object_items[0][item_id]" required="required" class="item form-control" id="">
