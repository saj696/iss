...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li><?= $this->Html->link(__('Daily Sales Report'), ['action' => 'index']) ?></li>
    </ul>
</div>
    ...
    <div class="col-md-12">
        <div class="portlet box grey-cascade">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-plus-square-o fa-lg"></i><?= __('Daily Sales Report') ?>
                </div>
            </div>
            ...
            <div class="portlet-body">
                ...
                <div class="row">
                    <div class="col-md-7 col-md-offset-2">
                        <?php
                        echo $this->Form->input('start_date', ['label'=>'Cumulative Start Date', 'type'=>'text', 'class'=>'datepicker form-control', 'required'=>'required']);
